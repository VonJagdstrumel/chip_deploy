...
BUILD_KERN_VERSION=4.4.139
BUILD_FULL_VERSION=$BUILD_KERN_VERSION$LOCALVERSION
BUILD_TGT_ARCH=arm-linux-gnueabihf
BUILD_CPU_COUNT=$(nproc)
BUILD_WORKSPACE=$PWD

BUILD_KERN_REPO=ntc-linux
BUILD_KERN_BRANCH=ntc-stable-mlc-$BUILD_KERN_VERSION
BUILD_KERN_SRC=$BUILD_KERN_REPO-$BUILD_KERN_BRANCH
BUILD_KERN_ARCHIVE=$BUILD_KERN_BRANCH.tar.gz
BUILD_KERN_URL=https://github.com/kaplan2539/$BUILD_KERN_REPO/archive/$BUILD_KERN_ARCHIVE
